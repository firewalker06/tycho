...
function renderSummaryAttachmentMenu(agent, attachments = [], summaryId = "") {
  ...
  return `
    <div class="summary-attachment-menu" data-summary-attachment-menu data-summary-attachment-key="${escapeAttr(menuKey)}"${stateKey}>
      ...
      <div class="summary-attachment-menu-popover ui-overlay-surface hidden" data-summary-attachment-menu-popover data-summary-attachment-key="${escapeAttr(menuKey)}" data-overlay-kind="menu" data-preserve-scroll data-state-key="summary-attachment-menu-list:${escapeAttr(menuKey)}" tabindex="0" aria-label="Summary attachments">
