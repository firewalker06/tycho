...
function renderPersonalAssistant() {
  ...
  const continuity = item.handoff_path ? `<a href="${escapeAttr(item.handoff_path)}">Open continuity handoff</a>` : "A bounded continuity handoff appears after the daily summary.";
