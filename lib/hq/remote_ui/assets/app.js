    ...
    <div class="detail-row schedule-row">
      ...
      <div class="schedule-row-end">
        ...
        <div class="compact-actions schedule-row-actions">
          <button class="inline-icon-button" type="button" data-schedule-action="run" data-schedule-key="${escapeAttr(schedule.key)}">${iconSvg("activity")}<span>Run</span></button>
          <button class="inline-icon-button" type="button" data-schedule-action="${toggleAction}" data-schedule-key="${escapeAttr(schedule.key)}">${iconSvg(toggleIcon)}<span>${toggleLabel}</span></button>
        </div>
      </div>
    </div>
  `;
