...
function preserveAttachmentWorkspaceDuringPoll(options = {}) {
...
async function refresh(options = {}) {
  ...
  const preserveAttachmentWorkspace = preserveAttachmentWorkspaceDuringPoll(options);
  try {
    ...
    if (!preserveAttachmentWorkspace) await ensureRouteData(options);
    ...
    if (!preserveAttachmentWorkspace) {
      render({
