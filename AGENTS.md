...
- `TYCHO_REMOTE_UI_WORKSPACE_ONLY=1 TYCHO_REMOTE_UI_CAPTURE_DIR=/tmp/tycho-workspace-captures bin/remote-ui-smoke`: isolate the workspace browser route and capture desktop/mobile evidence when unrelated Remote UI assertions block the full smoke.
